...
const HeroesListItem: FC<IPropsType> = ({name, description, element, onDelete}: IPropsType) => {
    ...
    return (
        <li 
            ...
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Unknown_person.jpg/1200px-Unknown_person.jpg" 
